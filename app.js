(() => {
  ...
  const settingsVersion=Number(localStorage.getItem('kira.settingsVersion')||0);if(settingsVersion<11){localStorage.setItem('kira.settingsVersion','11');localStorage.setItem('kira.settings',JSON.stringify(state.settings));}
